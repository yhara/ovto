  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.defn(self, '$_run', TMP_App__run_8 = function $$_run($kwargs) {
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        view = self.$class().$const_get("View").$new(self.wired_actions);
        if ($truthy(id)) {
...
(function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_View_render_7;

      return (Opal.defn(self, '$render', TMP_View_render_7 = function $$render($kwargs) {
...
if (e == null) e = nil;
      ...
      }, TMP_View_render_7.$$arity = 1), nil) && 'render'
  ...
  return Opal.const_get_relative($nesting, 'MyApp').$run($hash2(["id"], {"id": "ovto-view"}));
})(Opal);
