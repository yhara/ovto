...
Opal.modules["ovto/app"] = function(Opal) {
  ...
  Opal.add_stubs(['$run', '$new', '$const_get', '$class', '$attr_reader', '$log_error', '$_run', '$private', '$wired_actions=', '$-', '$setup']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_App_run_1, TMP_App_initialize_2, TMP_App_actions_3, TMP_App__set_state_4, TMP_App_run_6, TMP_App_setup_7, TMP_App__run_8;
      ...
      self.$private();
      return (Opal.defn(self, '$_run', TMP_App__run_8 = function $$_run($kwargs) {
        ...
        return self.$setup();
      }, TMP_App__run_8.$$arity = -1), nil) && '_run';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/state"] = function(Opal) {
  ...
  Opal.add_stubs(['$instance_variable_set', '$<<', '$define_method', '$[]', '$-', '$keys', '$map', '$item_specs', '$class', '$to_proc', '$any?', '$raise', '$inspect', '$to_h', '$!', '$key?', '$name', '$attr_reader', '$new', '$merge', '$is_a?', '$==', '$values', '$object_id']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
