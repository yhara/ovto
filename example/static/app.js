...
Opal.modules["console"] = function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Console_clear_1, TMP_Console_trace_2, TMP_Console_log_3, TMP_Console_info_4, TMP_Console_warn_5, TMP_Console_error_6, TMP_Console_time_7, TMP_Console_group_8, TMP_Console_group$B_9;

    def["native"] = nil;
    
    self.$include(Opal.const_get_relative($nesting, 'Native'));
    
    Opal.defn(self, '$clear', TMP_Console_clear_1 = function $$clear() {
      var self = this;

      return self["native"].clear()
    }, TMP_Console_clear_1.$$arity = 0);
    
    Opal.defn(self, '$trace', TMP_Console_trace_2 = function $$trace() {
      var self = this;

      return self["native"].trace()
    }, TMP_Console_trace_2.$$arity = 0);
    
    Opal.defn(self, '$log', TMP_Console_log_3 = function $$log($a_rest) {
      var self = this, args;
    ...
    }, TMP_Console_log_3.$$arity = -1);
    
    Opal.defn(self, '$info', TMP_Console_info_4 = function $$info($a_rest) {
      var self = this, args;
    ...
    }, TMP_Console_info_4.$$arity = -1);
    
    Opal.defn(self, '$warn', TMP_Console_warn_5 = function $$warn($a_rest) {
      var self = this, args;
    ...
    }, TMP_Console_warn_5.$$arity = -1);
    
    Opal.defn(self, '$error', TMP_Console_error_6 = function $$error($a_rest) {
      var self = this, args;
    ...
    }, TMP_Console_error_6.$$arity = -1);
    
    Opal.defn(self, '$time', TMP_Console_time_7 = function $$time(label) {
      var self = this, $iter = TMP_Console_time_7.$$p, block = $iter || nil;

      if ($iter) TMP_Console_time_7.$$p = null;
    ...
    }, TMP_Console_time_7.$$arity = 1);
    
    Opal.defn(self, '$group', TMP_Console_group_8 = function $$group($a_rest) {
      var self = this, args, $iter = TMP_Console_group_8.$$p, block = $iter || nil;
      ...
      if ($iter) TMP_Console_group_8.$$p = null;
    ...
    }, TMP_Console_group_8.$$arity = -1);
    return (Opal.defn(self, '$group!', TMP_Console_group$B_9 = function($a_rest) {
      var self = this, args, $iter = TMP_Console_group$B_9.$$p, block = $iter || nil;
      ...
      if ($iter) TMP_Console_group$B_9.$$p = null;
    ...
    }, TMP_Console_group$B_9.$$arity = -1), nil) && 'group!';
  })($nesting[0], null, $nesting);
  if ($truthy((typeof(Opal.global.console) !== "undefined"))) {
    return ($gvars.console = Opal.const_get_relative($nesting, 'Console').$new(Opal.global.console))
    } else {
    return nil
  };
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["ovto/actions"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_actions_1;

      def.wired_actions = nil;
      
      self.$attr_writer("wired_actions");
      return (Opal.defn(self, '$actions', TMP_Actions_actions_1 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Actions_actions_1.$$arity = 0), nil) && 'actions';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto/app"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  Opal.add_stubs(['$run', '$new', '$const_get', '$class', '$attr_reader', '$log_error', '$_run', '$private', '$wired_actions=', '$-', '$start_application', '$setup']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_App_run_1, TMP_App_initialize_2, TMP_App_actions_3, TMP_App__set_state_4, TMP_App_run_6, TMP_App_setup_7, TMP_App__run_8, TMP_App_start_application_9;

      def.wired_actions = nil;
      
      Opal.defs(self, '$run', TMP_App_run_1 = function $$run($a_rest) {
        var self = this, args;
        ...
        return $send(self.$new(), 'run', Opal.to_a(args))
      }, TMP_App_run_1.$$arity = -1);
      
      Opal.defn(self, '$initialize', TMP_App_initialize_2 = function $$initialize() {
        var self = this;

        
        self.state = self.$class().$const_get("State").$new();
        return (self.wired_actions = nil);
      }, TMP_App_initialize_2.$$arity = 0);
      self.$attr_reader("state");
      
      Opal.defn(self, '$actions', TMP_App_actions_3 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_App_actions_3.$$arity = 0);
      
      Opal.defn(self, '$_set_state', TMP_App__set_state_4 = function $$_set_state(new_state) {
        var self = this;

        return (self.state = new_state)
      }, TMP_App__set_state_4.$$arity = 1);
      
      Opal.defn(self, '$run', TMP_App_run_6 = function $$run($a_rest) {
        var TMP_5, self = this, args;
        ...
        return $send(Opal.const_get_relative($nesting, 'Ovto'), 'log_error', [], (TMP_5 = function(){var self = TMP_5.$$s || this;

        return $send(self, '_run', Opal.to_a(args))}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5))
      }, TMP_App_run_6.$$arity = -1);
      
      Opal.defn(self, '$setup', TMP_App_setup_7 = function $$setup() {
        var self = this;

        return nil
      }, TMP_App_setup_7.$$arity = 0);
      self.$private();
      
      Opal.defn(self, '$_run', TMP_App__run_8 = function $$_run($kwargs) {
        var self = this, id, runtime = nil, actions = nil, $writer = nil, view = nil;
        ...
        runtime = Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'Runtime').$new(self);
        actions = self.$class().$const_get("Actions").$new();
        self.wired_actions = Opal.const_get_relative($nesting, 'WiredActions').$new(actions, self, runtime);
        
        $writer = [self.wired_actions];
        $send(actions, 'wired_actions=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        view = self.$class().$const_get("MainComponent").$new(self.wired_actions);
        if ($truthy(id)) {
          ...
          document.addEventListener('DOMContentLoaded', function(){
            ...
            self.$start_application(runtime, view, container)
          });
        
          } else {
          return self.$start_application(runtime, view, nil)
        };
      }, TMP_App__run_8.$$arity = -1);
      return (Opal.defn(self, '$start_application', TMP_App_start_application_9 = function $$start_application(runtime, view, container) {
        var self = this;

        
        runtime.$run(view, container);
        return self.$setup();
      }, TMP_App_start_application_9.$$arity = 3), nil) && 'start_application';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto/component"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_minus(lhs, rhs) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, $hash = Opal.hash, $gvars = Opal.gvars;

  Opal.add_stubs(['$each', '$private', '$do_render', '$[]', '$parameters', '$method', '$nil?', '$accepts_state?', '$render', '$reject', '$==', '$empty?', '$is_a?', '$raise', '$render_children', '$===', '$render_component', '$extract_attrs', '$!', '$render_tag', '$merge_attrs', '$+', '$inspect', '$class', '$push', '$last', '$[]=', '$-', '$merge', '$to_s', '$call', '$pop', '$>', '$length', '$new', '$hash_to_js_obj']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_hash_to_js_obj_2, TMP_Component_initialize_3, TMP_Component_render_4, TMP_Component_render_view_5, TMP_Component_do_render_7, TMP_Component_accepts_state$q_9, TMP_Component_actions_10, TMP_Component_o_11, TMP_Component_extract_attrs_13, TMP_Component_merge_attrs_14, TMP_Component_render_children_15, TMP_Component_render_component_17, TMP_Component_render_tag_18;

      def.wired_actions = def.vdom_tree = def.done_render = def.current_state = nil;
      
      (function($base, $super, $parent_nesting) {
        function $MoreThanOneNode(){};
        var self = $MoreThanOneNode = $klass($base, $super, 'MoreThanOneNode', $MoreThanOneNode);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting);

        return nil
      })($nesting[0], Opal.const_get_relative($nesting, 'StandardError'), $nesting);
      Opal.defs(self, '$hash_to_js_obj', TMP_Component_hash_to_js_obj_2 = function $$hash_to_js_obj(hash) {
        var TMP_1, self = this, ret = nil;

        
        ret = {};
        $send(hash, 'each', [], (TMP_1 = function(k, v){var self = TMP_1.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return ret[k] = v}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1));
        return ret;
      }, TMP_Component_hash_to_js_obj_2.$$arity = 1);
      
      Opal.defn(self, '$initialize', TMP_Component_initialize_3 = function $$initialize(wired_actions) {
        var self = this;

        
        self.wired_actions = wired_actions;
        return (self.vdom_tree = []);
      }, TMP_Component_initialize_3.$$arity = 1);
      
      Opal.defn(self, '$render', TMP_Component_render_4 = function $$render() {
        var self = this;

        return ""
      }, TMP_Component_render_4.$$arity = 0);
      self.$private();
      
      Opal.defn(self, '$render_view', TMP_Component_render_view_5 = function $$render_view(state) {
        var self = this;

        return self.$do_render($hash2(["state"], {"state": state}))
      }, TMP_Component_render_view_5.$$arity = 1);
      
      Opal.defn(self, '$do_render', TMP_Component_do_render_7 = function $$do_render($kwargs) {
        var $a, $b, TMP_6, self = this, args, parameters = nil, args_wo_state = nil;
        ...
        parameters = self.$method("render").$parameters();
        if ($truthy(($truthy($a = ($truthy($b = !parameters) ? $b : parameters['$nil?']())) ? $a : self['$accepts_state?'](parameters)))) {
          return self.$render(Opal.to_hash(args))
          } else {
          
          args_wo_state = $send(args, 'reject', [], (TMP_6 = function(k, v){var self = TMP_6.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return k['$==']("state")}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6));
          return (function() {if ($truthy(args_wo_state['$empty?']())) {
            return self.$render()
            } else {
            return self.$render(Opal.to_hash(args_wo_state))
          }; return nil; })();
        };
      }, TMP_Component_do_render_7.$$arity = -1);
      
      Opal.defn(self, '$accepts_state?', TMP_Component_accepts_state$q_9 = function(parameters) {try {

        var TMP_8, self = this;

        
        $send(parameters, 'each', [], (TMP_8 = function(item){var self = TMP_8.$$s || this, $a, $b;
if (item == null) item = nil;
        if ($truthy(($truthy($a = ($truthy($b = item['$=='](["key", "state"])) ? $b : item['$=='](["keyreq", "state"]))) ? $a : item['$[]'](0)['$==']("keyrest")))) {
            Opal.ret(true)
            } else {
            return nil
      ...
      }, TMP_Component_accepts_state$q_9.$$arity = 1);
      
      Opal.defn(self, '$actions', TMP_Component_actions_10 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Component_actions_10.$$arity = 0);
      
      Opal.defn(self, '$o', TMP_Component_o_11 = function $$o(_tag_name, arg1, arg2) {
        var $a, TMP_12, self = this, $iter = TMP_Component_o_11.$$p, block = $iter || nil, attributes = nil, content = nil, children = nil, $case = nil, result = nil, tag_name = nil, base_attributes = nil, more_attributes = nil;
        ...
        if ($iter) TMP_Component_o_11.$$p = null;
        
        if ($truthy(arg1['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
        ...
        $case = _tag_name;
        if (Opal.const_get_relative($nesting, 'Class')['$===']($case)) {result = self.$render_component(_tag_name, attributes, children)}
        else if ("text"['$===']($case)) {
        if ($truthy(attributes['$empty?']())) {
          } else {
          self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "text cannot take attributes")
        };
        result = content;}
        else if (Opal.const_get_relative($nesting, 'String')['$===']($case)) {
        $a = [].concat(Opal.to_a(self.$extract_attrs(_tag_name))), (tag_name = ($a[0] == null ? nil : $a[0])), (base_attributes = ($a[1] == null ? nil : $a[1])), $a;
        more_attributes = $send(attributes, 'reject', [], (TMP_12 = function(k, v){var self = TMP_12.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return v['$!']()}, TMP_12.$$s = self, TMP_12.$$arity = 2, TMP_12));
        result = self.$render_tag(tag_name, self.$merge_attrs(base_attributes, more_attributes), children);}
        else {self.$raise(Opal.const_get_relative($nesting, 'TypeError'), $rb_plus("tag_name must be a String or Component but got ", Opal.const_get_relative($nesting, 'Ovto').$inspect(tag_name)))};
        if ($truthy(self.vdom_tree['$empty?']())) {
          
          if ($truthy(self.done_render)) {
            self.$raise(Opal.const_get_relative($nesting, 'MoreThanOneNode'), "" + (self.$class()) + "#render must generate a single DOM node. Please wrap the tags with a 'div' or something.")};
          self.done_render = true;
          return result;
          } else {
          
          self.vdom_tree.$last().$push(result);
          return self.vdom_tree.$last();
        };
      }, TMP_Component_o_11.$$arity = -2);
      
      Opal.defn(self, '$extract_attrs', TMP_Component_extract_attrs_13 = function $$extract_attrs(tag_name) {
        var $a, $b, self = this, $case = nil, class_name = nil, id = nil, attributes = nil, $writer = nil;

        
        $case = tag_name;
        if (/^([^.#]*)\.([-_\w]+)(\#([-_\w]+))?/['$===']($case)) {$a = [(function() {if ($truthy((($b = $gvars['~']) === nil ? nil : $b['$[]'](1))['$empty?']())) {
          return "div"
          } else {
          return (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))
        }; return nil; })(), (($b = $gvars['~']) === nil ? nil : $b['$[]'](2)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](4))], (tag_name = $a[0]), (class_name = $a[1]), (id = $a[2]), $a}
        else if (/^([^.#]*)\#([-_\w]+)(\.([-_\w]+))?/['$===']($case)) {$a = [(function() {if ($truthy((($b = $gvars['~']) === nil ? nil : $b['$[]'](1))['$empty?']())) {
          return "div"
          } else {
          return (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))
        }; return nil; })(), (($b = $gvars['~']) === nil ? nil : $b['$[]'](4)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](2))], (tag_name = $a[0]), (class_name = $a[1]), (id = $a[2]), $a}
        else {class_name = (id = nil)};
        attributes = $hash2([], {});
        if ($truthy(class_name)) {
      ...
      }, TMP_Component_extract_attrs_13.$$arity = 1);
      
      Opal.defn(self, '$merge_attrs', TMP_Component_merge_attrs_14 = function $$merge_attrs(base_attributes, attributes) {
        var $a, self = this, base_class = nil, more_class = nil, merged_class = nil;

        
        base_class = base_attributes['$[]']("class");
        more_class = attributes['$[]']("class");
        merged_class = (function() {if ($truthy(($truthy($a = base_class) ? more_class : $a))) {
          return $rb_plus($rb_plus(base_class, " "), more_class)
          } else {
          return ($truthy($a = base_class) ? $a : more_class)
        }; return nil; })();
        if ($truthy(merged_class)) {
          return base_attributes.$merge(attributes).$merge($hash2(["class"], {"class": merged_class}))
          } else {
          return base_attributes.$merge(attributes)
        };
      }, TMP_Component_merge_attrs_14.$$arity = 2);
      
      Opal.defn(self, '$render_children', TMP_Component_render_children_15 = function $$render_children(content, block) {
        var $a, self = this, block_value = nil, results = nil;
        ...
        return (function() {
        if ($truthy(($truthy($a = content) ? block : $a))) {return self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "o cannot take both content and block")}
        else if ($truthy(content)) {return [content.$to_s()]}
        else if ($truthy(block)) {
        self.vdom_tree.$push([]);
        block_value = block.$call();
        results = self.vdom_tree.$pop();
        if ($truthy($rb_gt(results.$length(), 0))) {
          return results
        } else if ($truthy(block_value['$is_a?'](Opal.const_get_relative($nesting, 'String')))) {
          return [block_value]
          } else {
          return []
        };}
        else {return []}})()
      }, TMP_Component_render_children_15.$$arity = -1);
      
      Opal.defn(self, '$render_component', TMP_Component_render_component_17 = function $$render_component(comp_class, args, children) {
        var TMP_16, self = this, comp = nil, render_args = nil;

        
        comp = comp_class.$new(self.wired_actions);
        render_args = $hash2(["state"], {"state": self.current_state}).$merge(args);
        return $send(comp, 'do_render', [Opal.to_hash(render_args)], (TMP_16 = function(){var self = TMP_16.$$s || this;

        return children}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16));
      }, TMP_Component_render_component_17.$$arity = 3);
      return (Opal.defn(self, '$render_tag', TMP_Component_render_tag_18 = function $$render_tag(tag_name, attributes, children) {
        var $a, self = this, js_attributes = nil, style = nil, ret = nil;

        
        js_attributes = Opal.const_get_relative($nesting, 'Component').$hash_to_js_obj(($truthy($a = attributes) ? $a : $hash2([], {})));
        if ($truthy((style = attributes['$[]']("style")))) {
          js_attributes.style = Opal.const_get_relative($nesting, 'Component').$hash_to_js_obj(style)};
        children = ($truthy($a = children) ? $a : null);
        ret = 
        {
          nodeName: tag_name,
      ...
      ;
        return ret;
      }, TMP_Component_render_tag_18.$$arity = 3), nil) && 'render_tag';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
/* Generated by Opal 0.11.4 */
Opal.modules["ovto/fetch"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$!=', '$to_json', '$_do_fetch', '$new', '$resolve', '$parse', '$reject']);
  ...
  return (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Ovto_fetch_1, TMP_Ovto__do_fetch_2;

    
    Opal.defs(self, '$fetch', TMP_Ovto_fetch_1 = function $$fetch(url, method, data) {
      var self = this, init = nil;
      ...
      return self.$_do_fetch(url, init);
    }, TMP_Ovto_fetch_1.$$arity = -2);
    Opal.defs(self, '$_do_fetch', TMP_Ovto__do_fetch_2 = function $$_do_fetch(url, init) {
      var self = this, promise = nil, text = nil, error = nil;
      ...
      fetch(url, init).then(response => {
        ...
        promise.$resolve(Opal.const_get_relative($nesting, 'JSON').$parse(text))
      ).catch(error =>
        promise.$reject(error)
      );
    ;
      return promise;
    }, TMP_Ovto__do_fetch_2.$$arity = 2);
  })($nesting[0], $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto/runtime"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$lambda', '$state', '$call', '$Native']);
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      function $Runtime(){};
      var self = $Runtime = $klass($base, $super, 'Runtime', $Runtime);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Runtime_initialize_1, TMP_Runtime_run_3, TMP_Runtime_scheduleRender_4;

      def.scheduleRender = nil;
      
      
      Opal.defn(self, '$initialize', TMP_Runtime_initialize_1 = function $$initialize(app) {
        var self = this;

        return (self.app = app)
      }, TMP_Runtime_initialize_1.$$arity = 1);
      
      Opal.defn(self, '$run', TMP_Runtime_run_3 = function $$run(view, container) {
        var TMP_2, self = this, getState = nil;

        
        getState = $send(self, 'lambda', [], (TMP_2 = function(){var self = TMP_2.$$s || this;
          if (self.app == null) self.app = nil;

        return self.app.$state()}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
        return (self.scheduleRender = Ovto.run(getState, view, container));
      }, TMP_Runtime_run_3.$$arity = 2);
      return (Opal.defn(self, '$scheduleRender', TMP_Runtime_scheduleRender_4 = function $$scheduleRender() {
        var self = this;

        return self.scheduleRender.$call()
      }, TMP_Runtime_scheduleRender_4.$$arity = 0), nil) && 'scheduleRender';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
...
/* Generated by Opal 0.11.4 */
Opal.modules["ovto/state"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  Opal.add_stubs(['$instance_variable_set', '$is_a?', '$raise', '$inspect', '$<<', '$define_method', '$[]', '$-', '$keys', '$map', '$item_specs', '$class', '$to_proc', '$any?', '$to_h', '$!', '$key?', '$name', '$attr_reader', '$new', '$merge', '$==', '$values', '$object_id']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_inherited_1, TMP_State_item_3, TMP_State_item_specs_4, TMP_State_initialize_6, TMP_State_merge_7, TMP_State_$$_8, TMP_State_$eq$eq_9, TMP_State_to_h_10, TMP_State_inspect_11;

      def.values = nil;
      
      (function($base, $super, $parent_nesting) {
        function $MissingValue(){};
        var self = $MissingValue = $klass($base, $super, 'MissingValue', $MissingValue);
      ...
      (function($base, $super, $parent_nesting) {
        function $UnknownKey(){};
        var self = $UnknownKey = $klass($base, $super, 'UnknownKey', $UnknownKey);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting);

        return nil
      })($nesting[0], Opal.const_get_relative($nesting, 'StandardError'), $nesting);
      Opal.defs(self, '$inherited', TMP_State_inherited_1 = function $$inherited(subclass) {
        var self = this;

        return subclass.$instance_variable_set("@item_specs", [])
      }, TMP_State_inherited_1.$$arity = 1);
      Opal.defs(self, '$item', TMP_State_item_3 = function $$item(name, options) {
        var TMP_2, self = this;
        if (self.item_specs == null) self.item_specs = nil;

        if (options == null) {
          options = $hash2([], {});
        }
        
        if ($truthy(options['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
          } else {
          self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "options must be a Hash: item :" + (name) + ", " + (options.$inspect()))
        };
        self.item_specs['$<<']([name, options]);
        return $send(self, 'define_method', [name], (TMP_2 = function(){var self = TMP_2.$$s || this;
          if (self.values == null) self.values = nil;

        return self.values['$[]'](name)}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
      }, TMP_State_item_3.$$arity = -2);
      Opal.defs(self, '$item_specs', TMP_State_item_specs_4 = function $$item_specs() {
        var self = this;
        if (self.item_specs == null) self.item_specs = nil;

        return self.item_specs
      }, TMP_State_item_specs_4.$$arity = 0);
      
      Opal.defn(self, '$initialize', TMP_State_initialize_6 = function $$initialize(hash) {
        var TMP_5, self = this, unknown_keys = nil;

        if (hash == null) {
          hash = $hash2([], {});
        }
        
        unknown_keys = $rb_minus(hash.$keys(), $send(self.$class().$item_specs(), 'map', [], "first".$to_proc()));
        if ($truthy(unknown_keys['$any?']())) {
          self.$raise(Opal.const_get_relative($nesting, 'UnknownKey'), "" + "unknown key(s): " + (unknown_keys.$inspect()))};
        return (self.values = $send(self.$class().$item_specs(), 'map', [], (TMP_5 = function(name, options){var self = TMP_5.$$s || this, $a, value = nil;
if (name == null) name = nil;if (options == null) options = nil;
        
          if ($truthy(($truthy($a = hash['$key?'](name)['$!']()) ? options['$key?']("default")['$!']() : $a))) {
            self.$raise(Opal.const_get_relative($nesting, 'MissingValue'), "" + ":" + (name) + " is mandatory for " + (self.$class().$name()) + ".new")};
          value = (function() {if ($truthy(hash['$key?'](name))) {
            return hash['$[]'](name)
            } else {
            return options['$[]']("default")
          }; return nil; })();
          return [name, value];}, TMP_5.$$s = self, TMP_5.$$arity = 2, TMP_5)).$to_h());
      }, TMP_State_initialize_6.$$arity = -1);
      self.$attr_reader("values");
      
      Opal.defn(self, '$merge', TMP_State_merge_7 = function $$merge(hash) {
        var self = this, unknown_keys = nil;

        
        unknown_keys = $rb_minus(hash.$keys(), $send(self.$class().$item_specs(), 'map', [], "first".$to_proc()));
        if ($truthy(unknown_keys['$any?']())) {
          self.$raise(Opal.const_get_relative($nesting, 'UnknownKey'), "" + "unknown key(s): " + (unknown_keys.$inspect()))};
        return self.$class().$new(self.values.$merge(hash));
      }, TMP_State_merge_7.$$arity = 1);
      
      Opal.defn(self, '$[]', TMP_State_$$_8 = function(key) {
        var self = this;

        return self.values['$[]'](key)
      }, TMP_State_$$_8.$$arity = 1);
      
      Opal.defn(self, '$==', TMP_State_$eq$eq_9 = function(other) {
        var $a, self = this;

        return ($truthy($a = other['$is_a?'](Opal.const_get_relative($nesting, 'State'))) ? self.$values()['$=='](other.$values()) : $a)
      }, TMP_State_$eq$eq_9.$$arity = 1);
      
      Opal.defn(self, '$to_h', TMP_State_to_h_10 = function $$to_h() {
        var self = this;

        return self.values
      }, TMP_State_to_h_10.$$arity = 0);
      return (Opal.defn(self, '$inspect', TMP_State_inspect_11 = function $$inspect() {
        var self = this;

        return "" + "#<" + (self.$class().$name()) + ":" + (self.$object_id()) + " " + (self.values.$inspect()) + ">"
      }, TMP_State_inspect_11.$$arity = 0), nil) && 'inspect';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto/version"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'VERSION', "0.2.3")
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto/wired_actions"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2, $hash = Opal.hash, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$invoke_action', '$respond_to?', '$private', '$merge', '$state', '$__send__', '$nil?', '$is_a?', '$!=', '$scheduleRender', '$_set_state']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var self = $WiredActions = $klass($base, $super, 'WiredActions', $WiredActions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_WiredActions_initialize_1, TMP_WiredActions_method_missing_2, TMP_WiredActions_respond_to$q_3, TMP_WiredActions_invoke_action_4;

      def.actions = def.app = def.runtime = nil;
      
      
      Opal.defn(self, '$initialize', TMP_WiredActions_initialize_1 = function $$initialize(actions, app, runtime) {
        var $a, self = this;

        return $a = [actions, app, runtime], (self.actions = $a[0]), (self.app = $a[1]), (self.runtime = $a[2]), $a
      }, TMP_WiredActions_initialize_1.$$arity = 3);
      
      Opal.defn(self, '$method_missing', TMP_WiredActions_method_missing_2 = function $$method_missing(name, args_hash) {
        var self = this;

        if (args_hash == null) {
          args_hash = $hash2([], {});
        }
        return self.$invoke_action(name, args_hash)
      }, TMP_WiredActions_method_missing_2.$$arity = -2);
      
      Opal.defn(self, '$respond_to?', TMP_WiredActions_respond_to$q_3 = function(name) {
        var self = this;

        return self.actions['$respond_to?'](name)
      }, TMP_WiredActions_respond_to$q_3.$$arity = 1);
      self.$private();
      return (Opal.defn(self, '$invoke_action', TMP_WiredActions_invoke_action_4 = function $$invoke_action(name, args_hash) {
        var $a, $b, self = this, kwargs = nil, state_diff = nil, new_state = nil;

        
        kwargs = $hash2(["state"], {"state": self.app.$state()}).$merge(args_hash);
        state_diff = self.actions.$__send__(name, Opal.to_hash(kwargs));
        if ($truthy(($truthy($a = ($truthy($b = state_diff['$nil?']()) ? $b : state_diff['$is_a?'](Opal.const_get_relative($nesting, 'Promise')))) ? $a : !!state_diff.then))) {
          return nil};
        new_state = self.app.$state().$merge(state_diff);
        if ($truthy(new_state['$!='](self.app.$state()))) {
          
          self.runtime.$scheduleRender();
          self.app.$_set_state(new_state);};
        return new_state;
      }, TMP_WiredActions_invoke_action_4.$$arity = 2), nil) && 'invoke_action';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};

/* Generated by Opal 0.11.4 */
Opal.modules["ovto"] = function(Opal) {
  var TMP_console_1, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $module = Opal.module, $truthy = Opal.truthy;

  Opal.add_stubs(['$==', '$require', '$inspect', '$call', '$raise', '$name', '$class', '$Array', '$backtrace']);
  
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    
    self.$require("console");
    
    Opal.defn(Opal.Object, '$console', TMP_console_1 = function $$console() {
      var self = this;
      if ($gvars.console == null) $gvars.console = nil;

      return $gvars.console
    }, TMP_console_1.$$arity = 0);
    self.$require("ovto"+ '/../' + "ovto/actions");
    self.$require("ovto"+ '/../' + "ovto/app");
    self.$require("ovto"+ '/../' + "ovto/component");
    self.$require("ovto"+ '/../' + "ovto/fetch");
    self.$require("ovto"+ '/../' + "ovto/runtime");
    self.$require("ovto"+ '/../' + "ovto/state");
    self.$require("ovto"+ '/../' + "ovto/version");
    self.$require("ovto"+ '/../' + "ovto/wired_actions");
    } else {
    nil
  };
  return (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Ovto_inspect_2, TMP_Ovto_log_error_3;

    
    Opal.defs(self, '$inspect', TMP_Ovto_inspect_2 = function $$inspect(obj) {
      var self = this;

      if ($truthy(obj.$inspect)) {
        return obj.$inspect()
        } else {
        return JSON.stringify(obj) || "undefined"
      }
    }, TMP_Ovto_inspect_2.$$arity = 1);
    Opal.defs(self, '$log_error', TMP_Ovto_log_error_3 = function $$log_error() {
      var self = this, $iter = TMP_Ovto_log_error_3.$$p, block = $iter || nil, ex = nil, div = nil;

      if ($iter) TMP_Ovto_log_error_3.$$p = null;
      try {
        return block.$call()
      } catch ($err) {
        if (Opal.rescue($err, [Opal.const_get_relative($nesting, 'Exception')])) {ex = $err;
          try {
            
            if ($truthy(typeof document === 'undefined')) {
              self.$raise(ex)};
            div = document.getElementById('ovto-debug');
            if ($truthy(div && !ex.OvtoPrinted)) {
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$item', '$+', '$/', '$*', '$celsius', '$-', '$o', '$lambda', '$set_celsius', '$actions', '$to_i', '$value', '$target', '$set_fahrenheit', '$fahrenheit', '$run']);
  
  self.$require("ovto");
  (function($base, $super, $parent_nesting) {
    function $MyApp(){};
    var self = $MyApp = $klass($base, $super, 'MyApp', $MyApp);
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_fahrenheit_1;

      
      self.$item("celsius", $hash2(["default"], {"default": 0}));
      return (Opal.defn(self, '$fahrenheit', TMP_State_fahrenheit_1 = function $$fahrenheit() {
        var self = this;

        return $rb_plus($rb_divide($rb_times(self.$celsius(), 9), 5.0), 32)
      }, TMP_State_fahrenheit_1.$$arity = 0), nil) && 'fahrenheit';
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_set_celsius_2, TMP_Actions_set_fahrenheit_3;

      
      
      Opal.defn(self, '$set_celsius', TMP_Actions_set_celsius_2 = function $$set_celsius($kwargs) {
        var self = this, state, value;
        ...
        if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'state')) {
          throw Opal.ArgumentError.$new('missing keyword: state');
        }
        state = $kwargs.$$smap["state"];
        if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'value')) {
          throw Opal.ArgumentError.$new('missing keyword: value');
        }
        value = $kwargs.$$smap["value"];
        return $hash2(["celsius"], {"celsius": value})
      }, TMP_Actions_set_celsius_2.$$arity = 1);
      return (Opal.defn(self, '$set_fahrenheit', TMP_Actions_set_fahrenheit_3 = function $$set_fahrenheit($kwargs) {
        var self = this, state, value, new_celsius = nil;
        ...
        new_celsius = $rb_divide($rb_times($rb_minus(value, 32), 5), 9.0);
        return $hash2(["celsius"], {"celsius": new_celsius});
      }, TMP_Actions_set_fahrenheit_3.$$arity = 1), nil) && 'set_fahrenheit';
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'Actions'), $nesting);
    return (function($base, $super, $parent_nesting) {
      function $MainComponent(){};
      var self = $MainComponent = $klass($base, $super, 'MainComponent', $MainComponent);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MainComponent_render_7;

      return (Opal.defn(self, '$render', TMP_MainComponent_render_7 = function $$render($kwargs) {
        var TMP_4, self = this, state;
        ...
        state = $kwargs.$$smap["state"];
        return $send(self, 'o', ["div"], (TMP_4 = function(){var self = TMP_4.$$s || this, TMP_5, TMP_6;

        
          self.$o("span", "Celcius:");
          self.$o("input", $hash2(["type", "onchange", "value"], {"type": "text", "onchange": $send(self, 'lambda', [], (TMP_5 = function(e){var self = TMP_5.$$s || this;
if (e == null) e = nil;
          return self.$actions().$set_celsius($hash2(["value"], {"value": e.$target().$value().$to_i()}))}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5)), "value": state.$celsius()}));
          self.$o("span", "Fahrenheit:");
          return self.$o("input", $hash2(["type", "onchange", "value"], {"type": "text", "onchange": $send(self, 'lambda', [], (TMP_6 = function(e){var self = TMP_6.$$s || this;
if (e == null) e = nil;
          return self.$actions().$set_fahrenheit($hash2(["value"], {"value": e.$target().$value().$to_i()}))}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6)), "value": state.$fahrenheit()}));}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4))
      }, TMP_MainComponent_render_7.$$arity = 1), nil) && 'render'
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'Component'), $nesting);
  })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'App'), $nesting);
  return Opal.const_get_relative($nesting, 'MyApp').$run($hash2(["id"], {"id": "ovto"}));
})(Opal);
