...
Opal.modules["ovto/app"] = function(Opal) {
  ...
  Opal.add_stubs(['$log_error', '$run', '$new', '$const_get', '$class', '$attr_reader']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_App_run_2, TMP_App_initialize_3, TMP_App__set_state_4, TMP_App_run_5;

      
      Opal.defs(self, '$run', TMP_App_run_2 = function $$run($a_rest) {
        ...
        return $send(Opal.const_get_relative($nesting, 'Ovto'), 'log_error', [], (TMP_1 = function(){var self = TMP_1.$$s || this;

        return $send(self.$new(), 'run', Opal.to_a(args))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
      }, TMP_App_run_2.$$arity = -1);
      
      Opal.defn(self, '$initialize', TMP_App_initialize_3 = function $$initialize() {
        var self = this;

        return (self.state = self.$class().$const_get("State").$new())
      }, TMP_App_initialize_3.$$arity = 0);
      ...
      return (Opal.defn(self, '$run', TMP_App_run_5 = function $$run($kwargs) {
        var self = this, id, runtime = nil, wired_actions = nil, view = nil;
        ...
        wired_actions = Opal.const_get_relative($nesting, 'WiredActions').$new(self.$class().$const_get("Actions").$new(), self, runtime);
        ...
        if ($truthy(id)) {
          ...
          return runtime.$run(view, nil)
        };
      }, TMP_App_run_5.$$arity = -1), nil) && 'run';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/component"] = function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, $gvars = Opal.gvars, $hash = Opal.hash;

  Opal.add_stubs(['$each', '$private', '$render', '$is_a?', '$==', '$raise', '$reject!', '$!', '$render_children', '$===', '$render_component', '$empty?', '$extract_attrs', '$render_tag', '$merge', '$+', '$inspect', '$class', '$push', '$last', '$[]=', '$-', '$Array', '$call', '$pop', '$>', '$length', '$new', '$hash_to_js_obj', '$[]']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_hash_to_js_obj_2, TMP_Component_initialize_3, TMP_Component_render_4, TMP_Component_do_render_5, TMP_Component_actions_6, TMP_Component_o_7, TMP_Component_extract_attrs_9, TMP_Component_render_children_10, TMP_Component_render_component_12, TMP_Component_render_tag_13;

      def.wired_actions = def.vdom_tree = def.done_render = nil;
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      Opal.defn(self, '$do_render', TMP_Component_do_render_5 = function $$do_render(state) {
        var self = this;

        
        self.vdom_tree = [];
        self.done_render = false;
        return self.$render($hash2(["state"], {"state": state}));
      }, TMP_Component_do_render_5.$$arity = 1);
      
      Opal.defn(self, '$actions', TMP_Component_actions_6 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Component_actions_6.$$arity = 0);
      
      Opal.defn(self, '$o', TMP_Component_o_7 = function $$o(_tag_name, arg1, arg2) {
        var TMP_8, $a, self = this, $iter = TMP_Component_o_7.$$p, block = $iter || nil, attributes = nil, content = nil, children = nil, $case = nil, result = nil, tag_name = nil, base_attributes = nil;
        ...
        if ($iter) TMP_Component_o_7.$$p = null;
        ...
        $send(attributes, 'reject!', [], (TMP_8 = function(k, v){var self = TMP_8.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return v['$!']()}, TMP_8.$$s = self, TMP_8.$$arity = 2, TMP_8));
        ...
        result = self.$render_tag(tag_name, base_attributes.$merge(attributes), children);}
      ...
      }, TMP_Component_o_7.$$arity = -2);
      
      Opal.defn(self, '$extract_attrs', TMP_Component_extract_attrs_9 = function $$extract_attrs(tag_name) {
        var $a, $b, self = this, $case = nil, class_name = nil, id = nil, attributes = nil, $writer = nil;

        
        $case = tag_name;
        if (/^([^.#]+)\.([-_\w]+)(\#([-_\w]+))?/['$===']($case)) {$a = [(($b = $gvars['~']) === nil ? nil : $b['$[]'](1)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](2)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](4))], (tag_name = $a[0]), (class_name = $a[1]), (id = $a[2]), $a}
        else if (/^([^.#]+)\#([-_\w]+)(\.([-_\w]+))?/['$===']($case)) {$a = [(($b = $gvars['~']) === nil ? nil : $b['$[]'](1)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](4)), (($b = $gvars['~']) === nil ? nil : $b['$[]'](2))], (tag_name = $a[0]), (class_name = $a[1]), (id = $a[2]), $a}
      ...
      }, TMP_Component_extract_attrs_9.$$arity = 1);
      
      Opal.defn(self, '$render_children', TMP_Component_render_children_10 = function $$render_children(content, block) {
        ...
        else if ($truthy(content)) {return self.$Array(content)}
      ...
      }, TMP_Component_render_children_10.$$arity = -1);
      
      Opal.defn(self, '$render_component', TMP_Component_render_component_12 = function $$render_component(comp_class, args, children) {
        var TMP_11, self = this, comp = nil;

        
        comp = comp_class.$new(self.wired_actions);
        return $send(comp, 'render', [Opal.to_hash(args)], (TMP_11 = function(){var self = TMP_11.$$s || this;

        return children}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11));
      }, TMP_Component_render_component_12.$$arity = 3);
      return (Opal.defn(self, '$render_tag', TMP_Component_render_tag_13 = function $$render_tag(tag_name, attributes, children) {
      ...
      ;
        return ret;
      }, TMP_Component_render_tag_13.$$arity = 3), nil) && 'render_tag';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/state"] = function(Opal) {
  ...
  Opal.add_stubs(['$instance_variable_set', '$<<', '$define_method', '$[]', '$to_h', '$map', '$item_specs', '$class', '$!', '$key?', '$raise', '$name', '$new', '$merge', '$object_id', '$inspect']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_inherited_1, TMP_State_item_3, TMP_State_item_specs_4, TMP_State_initialize_6, TMP_State_merge_7, TMP_State_$$_8, TMP_State_to_h_9, TMP_State_inspect_10;
...
if (name == null) name = nil;if (options == null) options = nil;
      ...
      Opal.defn(self, '$to_h', TMP_State_to_h_9 = function $$to_h() {
        var self = this;

        return self.values
      }, TMP_State_to_h_9.$$arity = 0);
      return (Opal.defn(self, '$inspect', TMP_State_inspect_10 = function $$inspect() {
        var self = this;

        return "" + "#<" + (self.$class().$name()) + ":" + (self.$object_id()) + " " + (self.values.$inspect()) + ">"
      }, TMP_State_inspect_10.$$arity = 0), nil) && 'inspect';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/version"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'VERSION', "0.0.0")
  })($nesting[0], $nesting)
};

/* Generated by Opal 0.11.0 */
Opal.modules["ovto/wired_actions"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2, $hash = Opal.hash;

  Opal.add_stubs(['$invoke_action', '$respond_to?', '$private', '$merge', '$state', '$__send__', '$_set_state', '$scheduleRender']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (Opal.defn(self, '$invoke_action', TMP_WiredActions_invoke_action_4 = function $$invoke_action(name, args_hash) {
        var self = this, kwargs = nil, state_diff = nil, new_state = nil;
...
Opal.modules["ovto"] = function(Opal) {
  ...
  Opal.add_stubs(['$==', '$inspect', '$call', '$name', '$class', '$Array', '$backtrace', '$raise']);
  ...
  return (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Ovto_inspect_1, TMP_Ovto_log_error_2;

    
    Opal.defs(self, '$inspect', TMP_Ovto_inspect_1 = function $$inspect(obj) {
      var self = this;
    ...
    }, TMP_Ovto_inspect_1.$$arity = 1);
    Opal.defs(self, '$log_error', TMP_Ovto_log_error_2 = function $$log_error() {
      var self = this, $iter = TMP_Ovto_log_error_2.$$p, block = $iter || nil, ex = nil, div = nil;

      if ($iter) TMP_Ovto_log_error_2.$$p = null;
      try {
        return block.$call()
      } catch ($err) {
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$item', '$+', '$count', '$o', '$lambda', '$increment', '$actions', '$run']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return self.$item("count", $hash2(["default"], {"default": 0}))
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_increment_1;

      return (Opal.defn(self, '$increment', TMP_Actions_increment_1 = function $$increment($kwargs) {
        var self = this, state, by;
        ...
        if (!Opal.hasOwnProperty.call($kwargs.$$smap, 'by')) {
          throw Opal.ArgumentError.$new('missing keyword: by');
        }
        by = $kwargs.$$smap["by"];
        return $hash2(["count"], {"count": $rb_plus(state.$count(), by)})
      }, TMP_Actions_increment_1.$$arity = 1), nil) && 'increment'
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_View_render_5;

      return (Opal.defn(self, '$render', TMP_View_render_5 = function $$render($kwargs) {
        var TMP_2, self = this, state;
        ...
        state = $kwargs.$$smap["state"];
        return $send(self, 'o', ["div"], (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_3, TMP_4;

        
          self.$o("span", state.$count());
          return $send(self, 'o', ["button", $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_3 = function(){var self = TMP_3.$$s || this;

          return self.$actions().$increment($hash2(["by"], {"by": 1}))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3))})], (TMP_4 = function(){var self = TMP_4.$$s || this;

          return "PRESS ME"}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4));}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2))
      }, TMP_View_render_5.$$arity = 1), nil) && 'render'
