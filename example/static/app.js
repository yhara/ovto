...
Opal.modules["ovto/component"] = function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $hash2 = Opal.hash2, $gvars = Opal.gvars, $hash = Opal.hash;

  Opal.add_stubs(['$each', '$private', '$is_a?', '$==', '$raise', '$reject!', '$render_children', '$===', '$render_component', '$empty?', '$extract_attrs', '$render_tag', '$merge', '$+', '$inspect', '$push', '$last', '$[]=', '$-', '$Array', '$call', '$pop', '$>', '$length', '$new', '$render', '$hash_to_js_obj']);
  return (function($base, $parent_nesting) {
    var $Ovto, self = $Ovto = $module($base, 'Ovto');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_hash_to_js_obj_2, TMP_Component_initialize_3, TMP_Component_render_4, TMP_Component_actions_5, TMP_Component_o_6, TMP_Component_extract_attrs_8, TMP_Component_render_children_9, TMP_Component_render_component_11, TMP_Component_render_tag_12;

      def.wired_actions = def.vdom_tree = nil;
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      Opal.defn(self, '$actions', TMP_Component_actions_5 = function $$actions() {
        var self = this;

        return self.wired_actions
      }, TMP_Component_actions_5.$$arity = 0);
      
      Opal.defn(self, '$o', TMP_Component_o_6 = function $$o(_tag_name, arg1, arg2) {
        var TMP_7, $a, self = this, $iter = TMP_Component_o_6.$$p, block = $iter || nil, attributes = nil, content = nil, children = nil, $case = nil, result = nil, tag_name = nil, base_attributes = nil;
        ...
        if ($iter) TMP_Component_o_6.$$p = null;
        ...
        $send(attributes, 'reject!', [], (TMP_7 = function(k, v){var self = TMP_7.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return !$truthy(v)}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7));
      ...
      }, TMP_Component_o_6.$$arity = -2);
      
      Opal.defn(self, '$extract_attrs', TMP_Component_extract_attrs_8 = function $$extract_attrs(tag_name) {
      ...
      }, TMP_Component_extract_attrs_8.$$arity = 1);
      
      Opal.defn(self, '$render_children', TMP_Component_render_children_9 = function $$render_children(content, block) {
      ...
      }, TMP_Component_render_children_9.$$arity = -1);
      
      Opal.defn(self, '$render_component', TMP_Component_render_component_11 = function $$render_component(comp_class, args, children) {
        var TMP_10, self = this, comp = nil;

        
        comp = comp_class.$new(self.wired_actions);
        return $send(comp, 'render', [Opal.to_hash(args)], (TMP_10 = function(){var self = TMP_10.$$s || this;

        return children}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10));
      }, TMP_Component_render_component_11.$$arity = 3);
      return (Opal.defn(self, '$render_tag', TMP_Component_render_tag_12 = function $$render_tag(tag_name, attributes, children) {
        var $a, self = this, ret = nil;

        
        attributes = Opal.const_get_relative($nesting, 'Component').$hash_to_js_obj(($truthy($a = attributes) ? $a : $hash2([], {})));
      ...
      ;
        return ret;
      }, TMP_Component_render_tag_12.$$arity = 3), nil) && 'render_tag';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["ovto/runtime"] = function(Opal) {
  ...
  Opal.add_stubs(['$lambda', '$state', '$call']);
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.defn(self, '$run', TMP_Runtime_run_3 = function $$run(view, container) {
        ...
        return (self.scheduleRender = Opal.Ovto.run(getState, view, container));
...
(function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_View_render_3;

      return (Opal.defn(self, '$render', TMP_View_render_3 = function $$render(state) {
        var TMP_2, self = this;

        
        self.$o("span", state.$count());
        return self.$o("button", $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_2 = function(){var self = TMP_2.$$s || this;

        return self.$actions().$increment($hash2(["by"], {"by": 1}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2))}));
      }, TMP_View_render_3.$$arity = 1), nil) && 'render'
